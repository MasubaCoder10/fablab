      ...
      <nav aria-label="Global" className=" flex items-center justify-around p-6 lg:px-8 fixed top-0 w-full bg-white bg-opacity-90">
        <div className="flex lg:flex">
          ...
          <div className='md:hidden flex items-center sm:ml-20'>
            <select
              ...
              style={{ backgroundImage: `url(${getFlagSrc(selectedLang)})`, backgroundSize: '24px 20px', backgroundRepeat: 'no-repeat', backgroundPosition: 'center left 8px' }}
            >
        ...
        <div className="hidden relative md:flex items-center">
            <select
              value={selectedLang}
              onChange={handleLanguageChange}
              className={`appearance-none border-none outline-none bg-transparent shadow-lg text-sm py-2 px-4 ${style.navbar_language}`}
